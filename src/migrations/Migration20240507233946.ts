...
export class Migration20240507233946 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "order_item" ("order_id" uuid not null, "product_id" uuid not null, "title" varchar(255) not null, "description" varchar(255) not null, "price" float not null, "count" int not null, constraint "order_item_pkey" primary key ("order_id", "product_id"));');
