...
export class Migration20240501002008 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "product" ("id" uuid not null, "title" varchar(255) not null, "description" varchar(255) not null, "price" numeric(10,0) not null, constraint "product_pkey" primary key ("id"));');
